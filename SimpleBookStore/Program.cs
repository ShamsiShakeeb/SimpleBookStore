...
using SimpleBookStore.BLL.Configurations;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Description = "Custom authorization header using the API Key (not Bearer)",
        Name = "Authorization", 
...
builder.Services.DAL(builder.Configuration);
builder.Services.BLL(builder.Configuration);
